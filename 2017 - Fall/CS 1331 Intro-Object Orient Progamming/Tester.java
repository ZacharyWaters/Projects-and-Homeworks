...
public class Tester {
    ...
    public static void main(String[] args) {
        try{
            ...
            Set<Square> set1 = new CopyOnWriteArraySet<Square>();
            ...
            Set<Square> set2 = new CopyOnWriteArraySet<Square>();
            ...
            Set<Square> set3 = new CopyOnWriteArraySet<Square>();
            ...
            Set<Square> set5 = new CopyOnWriteArraySet<Square>();
            ...
            if (s1.hashCode() != new Square("a2").hashCode()) {
                System.out.println("[WARNING] hashCode() for a Square instance"
                + " of 'a2' did not match hashCode() of another Square "
                + "instance of 'a2'. If two objects are equal by .equals(), "
                + "their hashCode()s should be equal. Unsure if this is O.K.");
            }
            ...
            try {
                ...
                setObjectArray = set.toArray();
                Square a4Square = new Square("a4");
                setObjectArray[0] = a4Square;
                if (set.contains(a4Square)) {
                    System.out.println("Changed element in Object[] and set "
